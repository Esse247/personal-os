# PERSONAL OS — Persistence & Execution Foundation v0.2
...
The source-of-truth entry point is [`PROJECT_MANIFEST.yaml`](PROJECT_MANIFEST.yaml). Setup
and demonstration commands are documented in [`docs/INDEX.md`](docs/INDEX.md).

Nothing in this repository connects to a live bank, calendar, email service, health
account, wearable, payment system, or production model API.
